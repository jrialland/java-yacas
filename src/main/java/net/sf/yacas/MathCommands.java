...
class MathCommands {
	public void AddCommands(final LispEnvironment aEnvironment) {
		...
		aEnvironment.CoreCommands().put("Hold", new YacasEvaluator(new LispQuote(), 1, YacasEvaluator.Fixed | YacasEvaluator.Macro));
		aEnvironment.CoreCommands().put("Eval", new YacasEvaluator(new LispEval(), 1, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("Write", new YacasEvaluator(new LispWrite(), 1, YacasEvaluator.Variable | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("WriteString", new YacasEvaluator(new LispWriteString(), 1, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("FullForm", new YacasEvaluator(new LispFullForm(), 1, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("DefaultDirectory", new YacasEvaluator(new LispDefaultDirectory(), 1, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("FromFile", new YacasEvaluator(new LispFromFile(), 2, YacasEvaluator.Fixed | YacasEvaluator.Macro));
		aEnvironment.CoreCommands().put("FromString", new YacasEvaluator(new LispFromString(), 2, YacasEvaluator.Fixed | YacasEvaluator.Macro));
		aEnvironment.CoreCommands().put("Read", new YacasEvaluator(new LispRead(), 0, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("ReadToken", new YacasEvaluator(new LispReadToken(), 0, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("ToFile", new YacasEvaluator(new LispToFile(), 2, YacasEvaluator.Fixed | YacasEvaluator.Macro));
		aEnvironment.CoreCommands().put("ToString", new YacasEvaluator(new LispToString(), 1, YacasEvaluator.Fixed | YacasEvaluator.Macro));
		aEnvironment.CoreCommands().put("ToStdout", new YacasEvaluator(new LispToStdout(), 1, YacasEvaluator.Fixed | YacasEvaluator.Macro));
		aEnvironment.CoreCommands().put("Load", new YacasEvaluator(new LispLoad(), 1, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("TmpFile", new YacasEvaluator(new LispTmpFile(), 0, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("Protect", new YacasEvaluator(new LispProtect(), 1, YacasEvaluator.Fixed | YacasEvaluator.Macro));
		aEnvironment.CoreCommands().put("UnProtect", new YacasEvaluator(new LispUnProtect(), 1, YacasEvaluator.Fixed | YacasEvaluator.Macro));
		aEnvironment.CoreCommands().put("IsProtected", new YacasEvaluator(new LispIsProtected(), 1, YacasEvaluator.Fixed | YacasEvaluator.Macro));
		aEnvironment.CoreCommands().put("Set", new YacasEvaluator(new LispSetVar(), 2, YacasEvaluator.Fixed | YacasEvaluator.Macro));
		aEnvironment.CoreCommands().put("MacroSet", new YacasEvaluator(new LispMacroSetVar(), 2, YacasEvaluator.Fixed | YacasEvaluator.Macro));
		aEnvironment.CoreCommands().put("Clear", new YacasEvaluator(new LispClearVar(), 1, YacasEvaluator.Variable | YacasEvaluator.Macro));
		aEnvironment.CoreCommands().put("MacroClear", new YacasEvaluator(new LispClearVar(), 1, YacasEvaluator.Variable | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("Local", new YacasEvaluator(new LispNewLocal(), 1, YacasEvaluator.Variable | YacasEvaluator.Macro));
		aEnvironment.CoreCommands().put("MacroLocal", new YacasEvaluator(new LispNewLocal(), 1, YacasEvaluator.Variable | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("Head", new YacasEvaluator(new LispHead(), 1, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("MathNth", new YacasEvaluator(new LispNth(), 2, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("Tail", new YacasEvaluator(new LispTail(), 1, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("DestructiveReverse", new YacasEvaluator(new LispDestructiveReverse(), 1, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("Length", new YacasEvaluator(new LispLength(), 1, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("List", new YacasEvaluator(new LispList(), 1, YacasEvaluator.Variable | YacasEvaluator.Macro));
		aEnvironment.CoreCommands().put("UnList", new YacasEvaluator(new LispUnList(), 1, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("Listify", new YacasEvaluator(new LispListify(), 1, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("Concat", new YacasEvaluator(new LispConcatenate(), 1, YacasEvaluator.Variable | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("ConcatStrings", new YacasEvaluator(new LispConcatenateStrings(), 1, YacasEvaluator.Variable | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("Delete", new YacasEvaluator(new LispDelete(), 2, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("DestructiveDelete", new YacasEvaluator(new LispDestructiveDelete(), 2, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("Insert", new YacasEvaluator(new LispInsert(), 3, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("DestructiveInsert", new YacasEvaluator(new LispDestructiveInsert(), 3, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("Replace", new YacasEvaluator(new LispReplace(), 3, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("DestructiveReplace", new YacasEvaluator(new LispDestructiveReplace(), 3, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("Atom", new YacasEvaluator(new LispAtomize(), 1, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("String", new YacasEvaluator(new LispStringify(), 1, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("CharString", new YacasEvaluator(new LispCharString(), 1, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("FlatCopy", new YacasEvaluator(new LispFlatCopy(), 1, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("Prog", new YacasEvaluator(new LispProgBody(), 1, YacasEvaluator.Variable | YacasEvaluator.Macro));
		aEnvironment.CoreCommands().put("While", new YacasEvaluator(new LispWhile(), 2, YacasEvaluator.Fixed | YacasEvaluator.Macro));
		aEnvironment.CoreCommands().put("If", new YacasEvaluator(new LispIf(), 2, YacasEvaluator.Variable | YacasEvaluator.Macro));
		aEnvironment.CoreCommands().put("Check", new YacasEvaluator(new LispCheck(), 2, YacasEvaluator.Fixed | YacasEvaluator.Macro));
		aEnvironment.CoreCommands().put("TrapError", new YacasEvaluator(new LispTrapError(), 2, YacasEvaluator.Fixed | YacasEvaluator.Macro));
		aEnvironment.CoreCommands().put("GetCoreError", new YacasEvaluator(new LispGetCoreError(), 0, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("Prefix", new YacasEvaluator(new LispPreFix(), 2, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("Infix", new YacasEvaluator(new LispInFix(), 2, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("Postfix", new YacasEvaluator(new LispPostFix(), 2, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("Bodied", new YacasEvaluator(new LispBodied(), 2, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("RuleBase", new YacasEvaluator(new LispRuleBase(), 2, YacasEvaluator.Fixed | YacasEvaluator.Macro));
		aEnvironment.CoreCommands().put("MacroRuleBase", new YacasEvaluator(new LispMacroRuleBase(), 2, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("RuleBaseListed", new YacasEvaluator(new LispRuleBaseListed(), 2, YacasEvaluator.Fixed | YacasEvaluator.Macro));
		aEnvironment.CoreCommands().put("MacroRuleBaseListed", new YacasEvaluator(new LispMacroRuleBaseListed(), 2, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("DefMacroRuleBase", new YacasEvaluator(new LispDefMacroRuleBase(), 2, YacasEvaluator.Fixed | YacasEvaluator.Macro));
		aEnvironment.CoreCommands().put("DefMacroRuleBaseListed", new YacasEvaluator(new LispDefMacroRuleBaseListed(), 2, YacasEvaluator.Fixed | YacasEvaluator.Macro));
		aEnvironment.CoreCommands().put("HoldArg", new YacasEvaluator(new LispHoldArg(), 2, YacasEvaluator.Fixed | YacasEvaluator.Macro));
		aEnvironment.CoreCommands().put("Rule", new YacasEvaluator(new LispNewRule(), 5, YacasEvaluator.Fixed | YacasEvaluator.Macro));
		aEnvironment.CoreCommands().put("MacroRule", new YacasEvaluator(new LispMacroNewRule(), 5, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("UnFence", new YacasEvaluator(new LispUnFence(), 2, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("Retract", new YacasEvaluator(new LispRetract(), 2, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("MathNot", new YacasEvaluator(new LispNot(), 1, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("Not", new YacasEvaluator(new LispNot(), 1, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("MathAnd", new YacasEvaluator(new LispLazyAnd(), 1, YacasEvaluator.Variable | YacasEvaluator.Macro));
		aEnvironment.CoreCommands().put("And", new YacasEvaluator(new LispLazyAnd(), 1, YacasEvaluator.Variable | YacasEvaluator.Macro));
		aEnvironment.CoreCommands().put("MathOr", new YacasEvaluator(new LispLazyOr(), 1, YacasEvaluator.Variable | YacasEvaluator.Macro));
		aEnvironment.CoreCommands().put("Or", new YacasEvaluator(new LispLazyOr(), 1, YacasEvaluator.Variable | YacasEvaluator.Macro));
		aEnvironment.CoreCommands().put("Equals", new YacasEvaluator(new LispEquals(), 2, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("=", new YacasEvaluator(new LispEquals(), 2, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("LessThan", new YacasEvaluator(new LispLessThan(), 2, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("GreaterThan", new YacasEvaluator(new LispGreaterThan(), 2, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("IsFunction", new YacasEvaluator(new LispIsFunction(), 1, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("IsAtom", new YacasEvaluator(new LispIsAtom(), 1, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("IsNumber", new YacasEvaluator(new LispIsNumber(), 1, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("IsInteger", new YacasEvaluator(new LispIsInteger(), 1, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("IsList", new YacasEvaluator(new LispIsList(), 1, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("IsString", new YacasEvaluator(new LispIsString(), 1, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("IsBound", new YacasEvaluator(new LispIsBound(), 1, YacasEvaluator.Fixed | YacasEvaluator.Macro));
		aEnvironment.CoreCommands().put("MathMultiply", new YacasEvaluator(new LispMultiply(), 2, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("MathAdd", new YacasEvaluator(new LispAdd(), 2, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("MathSubtract", new YacasEvaluator(new LispSubtract(), 2, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("MathDivide", new YacasEvaluator(new LispDivide(), 2, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("Builtin'Precision'Set", new YacasEvaluator(new YacasBuiltinPrecisionSet(), 1, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("MathGetExactBits", new YacasEvaluator(new LispGetExactBits(), 1, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("MathSetExactBits", new YacasEvaluator(new LispSetExactBits(), 2, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("MathBitCount", new YacasEvaluator(new LispBitCount(), 1, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("MathSign", new YacasEvaluator(new LispMathSign(), 1, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("MathIsSmall", new YacasEvaluator(new LispMathIsSmall(), 1, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("MathNegate", new YacasEvaluator(new LispMathNegate(), 1, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("MathFloor", new YacasEvaluator(new LispFloor(), 1, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("MathCeil", new YacasEvaluator(new LispCeil(), 1, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("MathAbs", new YacasEvaluator(new LispAbs(), 1, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("MathMod", new YacasEvaluator(new LispMod(), 2, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("MathDiv", new YacasEvaluator(new LispDiv(), 2, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("BitsToDigits", new YacasEvaluator(new LispBitsToDigits(), 2, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("DigitsToBits", new YacasEvaluator(new LispDigitsToBits(), 2, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("MathGcd", new YacasEvaluator(new LispGcd(), 2, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("SystemCall", new YacasEvaluator(new LispSystemCall(), 1, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("SystemName", new YacasEvaluator(new LispSystemName(), 0, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("FastArcSin", new YacasEvaluator(new LispFastArcSin(), 1, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("FastLog", new YacasEvaluator(new LispFastLog(), 1, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("FastPower", new YacasEvaluator(new LispFastPower(), 2, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("ShiftLeft", new YacasEvaluator(new LispShiftLeft(), 2, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("ShiftRight", new YacasEvaluator(new LispShiftRight(), 2, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("FromBase", new YacasEvaluator(new LispFromBase(), 2, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("ToBase", new YacasEvaluator(new LispToBase(), 2, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("MaxEvalDepth", new YacasEvaluator(new LispMaxEvalDepth(), 1, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("DefLoad", new YacasEvaluator(new LispDefLoad(), 1, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("Use", new YacasEvaluator(new LispUse(), 1, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("RightAssociative", new YacasEvaluator(new LispRightAssociative(), 1, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("LeftPrecedence", new YacasEvaluator(new LispLeftPrecedence(), 2, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("RightPrecedence", new YacasEvaluator(new LispRightPrecedence(), 2, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("IsBodied", new YacasEvaluator(new LispIsBodied(), 1, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("IsInfix", new YacasEvaluator(new LispIsInFix(), 1, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("IsPrefix", new YacasEvaluator(new LispIsPreFix(), 1, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("IsPostfix", new YacasEvaluator(new LispIsPostFix(), 1, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("OpPrecedence", new YacasEvaluator(new LispGetPrecedence(), 1, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("OpLeftPrecedence", new YacasEvaluator(new LispGetLeftPrecedence(), 1, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("OpRightPrecedence", new YacasEvaluator(new LispGetRightPrecedence(), 1, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("Builtin'Precision'Get", new YacasEvaluator(new YacasBuiltinPrecisionGet(), 0, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("BitAnd", new YacasEvaluator(new LispBitAnd(), 2, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("BitOr", new YacasEvaluator(new LispBitOr(), 2, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("BitXor", new YacasEvaluator(new LispBitXor(), 2, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("Secure", new YacasEvaluator(new LispSecure(), 1, YacasEvaluator.Fixed | YacasEvaluator.Macro));
		aEnvironment.CoreCommands().put("FindFile", new YacasEvaluator(new LispFindFile(), 1, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("FindFunction", new YacasEvaluator(new LispFindFunction(), 1, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("IsGeneric", new YacasEvaluator(new LispIsGeneric(), 1, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("GenericTypeName", new YacasEvaluator(new LispGenericTypeName(), 1, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("Array'Create", new YacasEvaluator(new GenArrayCreate(), 2, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("Array'Size", new YacasEvaluator(new GenArraySize(), 1, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("Array'Get", new YacasEvaluator(new GenArrayGet(), 2, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("Array'Set", new YacasEvaluator(new GenArraySet(), 3, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("CustomEval", new YacasEvaluator(new LispCustomEval(), 4, YacasEvaluator.Fixed | YacasEvaluator.Macro));
		aEnvironment.CoreCommands().put("CustomEval'Expression", new YacasEvaluator(new LispCustomEvalExpression(), 0, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("CustomEval'Result", new YacasEvaluator(new LispCustomEvalResult(), 0, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("CustomEval'Locals", new YacasEvaluator(new LispCustomEvalLocals(), 0, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("CustomEval'Stop", new YacasEvaluator(new LispCustomEvalStop(), 0, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("TraceRule", new YacasEvaluator(new LispTraceRule(), 2, YacasEvaluator.Fixed | YacasEvaluator.Macro));
		aEnvironment.CoreCommands().put("TraceStack", new YacasEvaluator(new LispTraceStack(), 1, YacasEvaluator.Fixed | YacasEvaluator.Macro));
		aEnvironment.CoreCommands().put("LispRead", new YacasEvaluator(new LispReadLisp(), 0, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("LispReadListed", new YacasEvaluator(new LispReadLispListed(), 0, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("Type", new YacasEvaluator(new LispType(), 1, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("StringMid'Get", new YacasEvaluator(new YacasStringMidGet(), 3, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("StringMid'Set", new YacasEvaluator(new YacasStringMidSet(), 3, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("Pattern'Create", new YacasEvaluator(new GenPatternCreate(), 2, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("Pattern'Matches", new YacasEvaluator(new GenPatternMatches(), 2, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("RuleBaseDefined", new YacasEvaluator(new LispRuleBaseDefined(), 2, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("DefLoadFunction", new YacasEvaluator(new LispDefLoadFunction(), 1, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("RuleBaseArgList", new YacasEvaluator(new LispRuleBaseArgList(), 2, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("RulePattern", new YacasEvaluator(new LispNewRulePattern(), 5, YacasEvaluator.Fixed | YacasEvaluator.Macro));
		aEnvironment.CoreCommands().put("MacroRulePattern", new YacasEvaluator(new LispMacroNewRulePattern(), 5, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("Subst", new YacasEvaluator(new LispSubst(), 3, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("LocalSymbols", new YacasEvaluator(new LispLocalSymbols(), 1, YacasEvaluator.Variable | YacasEvaluator.Macro));
		aEnvironment.CoreCommands().put("FastIsPrime", new YacasEvaluator(new LispFastIsPrime(), 1, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("MathFac", new YacasEvaluator(new LispFac(), 1, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("ApplyPure", new YacasEvaluator(new LispApplyPure(), 2, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("PrettyReader'Set", new YacasEvaluator(new YacasPrettyReaderSet(), 1, YacasEvaluator.Variable | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("PrettyPrinter'Set", new YacasEvaluator(new YacasPrettyPrinterSet(), 1, YacasEvaluator.Variable | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("PrettyPrinter'Get", new YacasEvaluator(new YacasPrettyPrinterGet(), 0, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("PrettyReader'Get", new YacasEvaluator(new YacasPrettyReaderGet(), 0, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("GarbageCollect", new YacasEvaluator(new LispGarbageCollect(), 0, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("SetGlobalLazyVariable", new YacasEvaluator(new LispSetGlobalLazyVariable(), 2, YacasEvaluator.Fixed | YacasEvaluator.Macro));
		aEnvironment.CoreCommands().put("PatchLoad", new YacasEvaluator(new LispPatchLoad(), 1, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("PatchString", new YacasEvaluator(new LispPatchString(), 1, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("ExtraInfo'Set", new YacasEvaluator(new YacasExtraInfoSet(), 2, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("ExtraInfo'Get", new YacasEvaluator(new YacasExtraInfoGet(), 1, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("DefaultTokenizer", new YacasEvaluator(new LispDefaultTokenizer(), 0, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("CommonLispTokenizer", new YacasEvaluator(new LispCommonLispTokenizer(), 0, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("XmlTokenizer", new YacasEvaluator(new LispXmlTokenizer(), 0, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("XmlExplodeTag", new YacasEvaluator(new LispExplodeTag(), 1, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("Builtin'Assoc", new YacasEvaluator(new YacasBuiltinAssoc(), 2, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("CurrentFile", new YacasEvaluator(new LispCurrentFile(), 0, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("CurrentLine", new YacasEvaluator(new LispCurrentLine(), 0, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("`", new YacasEvaluator(new LispBackQuote(), 1, YacasEvaluator.Fixed | YacasEvaluator.Macro));
		aEnvironment.CoreCommands().put("MathDebugInfo", new YacasEvaluator(new LispDumpBigNumberDebugInfo(), 1, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("InDebugMode", new YacasEvaluator(new LispInDebugMode(), 0, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("DebugFile", new YacasEvaluator(new LispDebugFile(), 1, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("DebugLine", new YacasEvaluator(new LispDebugLine(), 1, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("Version", new YacasEvaluator(new LispVersion(), 0, YacasEvaluator.Fixed | YacasEvaluator.Function));

		aEnvironment.CoreCommands().put("Exit", new YacasEvaluator(new LispExit(), 0, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("IsExitRequested", new YacasEvaluator(new LispExitRequested(), 0, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("HistorySize", new YacasEvaluator(new LispHistorySize(), 1, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("StaSiz", new YacasEvaluator(new LispStackSize(), 0, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("IsPromptShown", new YacasEvaluator(new LispIsPromptShown(), 0, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("ReadCmdLineString", new YacasEvaluator(new LispReadCmdLineString(), 1, YacasEvaluator.Fixed | YacasEvaluator.Function));
		aEnvironment.CoreCommands().put("GetTime", new YacasEvaluator(new LispTime(), 1, YacasEvaluator.Fixed | YacasEvaluator.Macro));
		aEnvironment.CoreCommands().put("FileSize", new YacasEvaluator(new LispFileSize(), 1, YacasEvaluator.Fixed | YacasEvaluator.Function));
	}
	...
	public static BigNumber GetNumber(final LispEnvironment aEnvironment, final int aStackTop, final int aArgNr) throws Exception {
		final BigNumber x = YacasEvalCaller.ARGUMENT(aEnvironment, aStackTop, aArgNr).Get().Number(aEnvironment.Precision());
		LispError.CHK_ARG_CORE(aEnvironment, aStackTop, x != null, aArgNr);
		return x;
	}

	static void MultiFix(final LispEnvironment aEnvironment, final int aStackTop, final LispOperators aOps) throws Exception {
		// Get operator
		LispError.CHK_ARG_CORE(aEnvironment, aStackTop, YacasEvalCaller.ARGUMENT(aEnvironment, aStackTop, 1).Get() != null, 1);
		final String orig = YacasEvalCaller.ARGUMENT(aEnvironment, aStackTop, 1).Get().String();
		LispError.CHK_ARG_CORE(aEnvironment, aStackTop, orig != null, 1);

		final LispPtr precedence = new LispPtr();
		...
		final int prec = Integer.parseInt(precedence.Get().String(), 10);
	...
	public static void SingleFix(final int aPrecedence, final LispEnvironment aEnvironment, final int aStackTop, final LispOperators aOps) throws Exception {
		// Get operator
		LispError.CHK_ARG_CORE(aEnvironment, aStackTop, YacasEvalCaller.ARGUMENT(aEnvironment, aStackTop, 1).Get() != null, 1);
		final String orig = YacasEvalCaller.ARGUMENT(aEnvironment, aStackTop, 1).Get().String();
		LispError.CHK_ARG_CORE(aEnvironment, aStackTop, orig != null, 1);
	...
	public static LispInFixOperator OperatorInfo(final LispEnvironment aEnvironment, final int aStackTop, final LispOperators aOperators) throws Exception {
		// Get operator
		LispError.CHK_ARG_CORE(aEnvironment, aStackTop, YacasEvalCaller.ARGUMENT(aEnvironment, aStackTop, 1).Get() != null, 1);

		final LispPtr evaluated = new LispPtr();
		evaluated.Set(YacasEvalCaller.ARGUMENT(aEnvironment, aStackTop, 1).Get());

		final String orig = evaluated.Get().String();
		LispError.CHK_ARG_CORE(aEnvironment, aStackTop, orig != null, 1);
		//
	...
	static void InternalSetVar(final LispEnvironment aEnvironment, final int aStackTop, final boolean aMacroMode, final boolean aGlobalLazyVariable) throws Exception {
	...
	public static void InternalDelete(final LispEnvironment aEnvironment, final int aStackTop, final boolean aDestructive) throws Exception {
		final LispPtr evaluated = new LispPtr();
		evaluated.Set(YacasEvalCaller.ARGUMENT(aEnvironment, aStackTop, 1).Get());
		LispError.CHK_ISLIST_CORE(aEnvironment, aStackTop, evaluated, 1);

		final LispPtr copied = new LispPtr();
		if (aDestructive) {
		...
		final LispPtr index = new LispPtr();
		...
		final LispIterator iter = new LispIterator(copied);
		while (ind > 0) {
			iter.GoNext();
			ind--;
		}
	...
	public static void InternalInsert(final LispEnvironment aEnvironment, final int aStackTop, final boolean aDestructive) throws Exception {
		final LispPtr evaluated = new LispPtr();
		evaluated.Set(YacasEvalCaller.ARGUMENT(aEnvironment, aStackTop, 1).Get());
		LispError.CHK_ISLIST_CORE(aEnvironment, aStackTop, evaluated, 1);
		...
		final LispPtr toInsert = new LispPtr();
	...
	public static void InternalReplace(final LispEnvironment aEnvironment, final int aStackTop, final boolean aDestructive) throws Exception {
		final LispPtr evaluated = new LispPtr();
		evaluated.Set(YacasEvalCaller.ARGUMENT(aEnvironment, aStackTop, 1).Get());
	...
	public static void InternalRuleBase(final LispEnvironment aEnvironment, final int aStackTop, final boolean aListed) throws Exception {
		// TESTARGS(3);
		...
		aEnvironment.DeclareRuleBase(LispStandard.SymbolName(aEnvironment, orig), args.Get().SubList().Get().Next(), aListed);

		// Return true
		LispStandard.InternalTrue(aEnvironment, YacasEvalCaller.RESULT(aEnvironment, aStackTop));
	}

	public static void InternalNewRule(final LispEnvironment aEnvironment, final int aStackTop) throws Exception {
		// TESTARGS(6);

		int arity;
		int precedence;

		final LispPtr ar = new LispPtr();
		final LispPtr pr = new LispPtr();
		final LispPtr predicate = new LispPtr();
		...
		// Finally define the rule base
		aEnvironment.DefineRule(LispStandard.SymbolName(aEnvironment, orig), arity, precedence, predicate, body);

		// Return true
		LispStandard.InternalTrue(aEnvironment, YacasEvalCaller.RESULT(aEnvironment, aStackTop));
	}

	void InternalDefMacroRuleBase(final LispEnvironment aEnvironment, final int aStackTop, final boolean aListed) throws Exception {
		// Get operator
		final LispPtr args = new LispPtr();
		...
		// Finally define the rule base
		aEnvironment.DeclareMacroRuleBase(LispStandard.SymbolName(aEnvironment, orig), args.Get().SubList().Get().Next(), aListed);

		// Return true
		LispStandard.InternalTrue(aEnvironment, YacasEvalCaller.RESULT(aEnvironment, aStackTop));
	}

	public void InternalNewRulePattern(final LispEnvironment aEnvironment, final int aStackTop, final boolean aMacroMode) throws Exception {
		int arity;
		int precedence;
		...
		// Finally define the rule base
		aEnvironment.DefineRulePattern(LispStandard.SymbolName(aEnvironment, orig), arity, precedence, predicate, body);
	...
	class LispQuote extends YacasEvalCaller {
		@Override
		public void Eval(final LispEnvironment aEnvironment, final int aStackTop) throws Exception {
	...
	class LispWrite extends YacasEvalCaller {
		@Override
		public void Eval(final LispEnvironment aEnvironment, final int aStackTop) throws Exception {
			final LispPtr subList = ARGUMENT(aEnvironment, aStackTop, 1).Get().SubList();
			if (subList != null) {
				final LispIterator iter = new LispIterator(subList);
				iter.GoNext();
	...
	class LispWriteString extends YacasEvalCaller {
		...
		public void Eval(final LispEnvironment aEnvironment, final int aStackTop) throws Exception {
			...
			final String str = ARGUMENT(aEnvironment, aStackTop, 1).Get().String();
	...
	class LispFullForm extends YacasEvalCaller {
		...
		public void Eval(final LispEnvironment aEnvironment, final int aStackTop) throws Exception {
			...
			final LispPrinter printer = new LispPrinter();
	...
	class LispDefaultDirectory extends YacasEvalCaller {
		...
		public void Eval(final LispEnvironment aEnvironment, final int aStackTop) throws Exception {
			// Get file name
			LispError.CHK_ARG_CORE(aEnvironment, aStackTop, ARGUMENT(aEnvironment, aStackTop, 1).Get() != null, 1);
			final String orig = ARGUMENT(aEnvironment, aStackTop, 1).Get().String();
			LispError.CHK_ARG_CORE(aEnvironment, aStackTop, orig != null, 1);
			final String oper = LispStandard.InternalUnstringify(orig);
	...
	class LispFromFile extends YacasEvalCaller {
		...
		public void Eval(final LispEnvironment aEnvironment, final int aStackTop) throws Exception {
			...
			final String hashedname = aEnvironment.HashTable().LookUpUnStringify(orig);
			...
			try {
				...
				final LispInput input = // new StdFileInput(hashedname, aEnvironment.iInputStatus);
	...
	class LispFromString extends YacasEvalCaller {
		...
		public void Eval(final LispEnvironment aEnvironment, final int aStackTop) throws Exception {
			...
			final StringInput newInput = new StringInput(new StringBuffer(oper), aEnvironment.iInputStatus);
	...
	class LispRead extends YacasEvalCaller {
		@Override
		public void Eval(final LispEnvironment aEnvironment, final int aStackTop) throws Exception {
			final InfixParser parser = new InfixParser(aEnvironment.iCurrentTokenizer, aEnvironment.iCurrentInput, aEnvironment, aEnvironment.iPrefixOperators, aEnvironment.iInfixOperators, aEnvironment.iPostfixOperators, aEnvironment.iBodiedOperators);
			// Read expression
	...
	class LispReadToken extends YacasEvalCaller {
		@Override
		public void Eval(final LispEnvironment aEnvironment, final int aStackTop) throws Exception {
			final LispTokenizer tok = aEnvironment.iCurrentTokenizer;
			String result;
	...
	class LispToFile extends YacasEvalCaller {
		...
		public void Eval(final LispEnvironment aEnvironment, final int aStackTop) throws Exception {
			...
			final FileOutputStream localFP = new FileOutputStream(oper);
			LispError.CHK_CORE(aEnvironment, aStackTop, localFP != null, LispError.KLispErrFileNotFound);
			final StdFileOutput newOutput = new StdFileOutput(localFP);
	...
	class LispToString extends YacasEvalCaller {
		@Override
		public void Eval(final LispEnvironment aEnvironment, final int aStackTop) throws Exception {
			final StringBuffer oper = new StringBuffer();
			final StringOutput newOutput = new StringOutput(oper);
			final LispOutput previous = aEnvironment.iCurrentOutput;
			aEnvironment.iCurrentOutput = newOutput;
			try {
				// Evaluate the body
	...
	class LispTmpFile extends YacasEvalCaller {
		...
		public void Eval(final LispEnvironment aEnvironment, final int aStackTop) throws Exception {
			...
			final File f = File.createTempFile("yacas", null);
			f.deleteOnExit();
	...
	class LispProtect extends YacasEvalCaller {
		@Override
		public void Eval(final LispEnvironment env, final int top) throws Exception {
			final String s = YacasEvalCaller.ARGUMENT(env, top, 1).Get().String();
	...
	class LispNewLocal extends YacasEvalCaller {
		...
		public void Eval(final LispEnvironment aEnvironment, final int aStackTop) throws Exception {
			...
			if (subList != null) {
				...
				int nr = 1;
				while (iter.GetObject() != null) {
					final String variable = iter.GetObject().String();
	...
	class LispTail extends YacasEvalCaller {
		@Override
		public void Eval(final LispEnvironment aEnvironment, final int aStackTop) throws Exception {
			final LispPtr first = new LispPtr();
			...
			final LispPtr head = new LispPtr();
	...
	class LispDestructiveReverse extends YacasEvalCaller {
		@Override
		public void Eval(final LispEnvironment aEnvironment, final int aStackTop) throws Exception {
			final LispPtr reversed = new LispPtr();
	...
	class LispLength extends YacasEvalCaller {
		...
		public void Eval(final LispEnvironment aEnvironment, final int aStackTop) throws Exception {
			final LispPtr subList = ARGUMENT(aEnvironment, aStackTop, 1).Get().SubList();
			if (subList != null) {
				final int num = LispStandard.InternalListLength(subList.Get().Next());
				RESULT(aEnvironment, aStackTop).Set(LispAtom.New(aEnvironment, "" + num));
				return;
			}
			final String string = ARGUMENT(aEnvironment, aStackTop, 1).Get().String();
			if (LispStandard.InternalIsString(string)) {
				final int num = string.length() - 2;
				RESULT(aEnvironment, aStackTop).Set(LispAtom.New(aEnvironment, "" + num));
				return;
			}
			final GenericClass gen = ARGUMENT(aEnvironment, aStackTop, 1).Get().Generic();
			if (gen != null) {
				if (gen.TypeName().equals("\"Array\"")) {
					final int size = ((ArrayClass) gen).Size();
	...
	class LispList extends YacasEvalCaller {
		@Override
		public void Eval(final LispEnvironment aEnvironment, final int aStackTop) throws Exception {
			final LispPtr all = new LispPtr();
			all.Set(aEnvironment.iList.Copy(false));
			final LispIterator tail = new LispIterator(all);
			tail.GoNext();
			final LispIterator iter = new LispIterator(ARGUMENT(aEnvironment, aStackTop, 1).Get().SubList());
			iter.GoNext();
			while (iter.GetObject() != null) {
				final LispPtr evaluated = new LispPtr();
	...
	class LispUnList extends YacasEvalCaller {
		...
		public void Eval(final LispEnvironment aEnvironment, final int aStackTop) throws Exception {
			...
			final LispObject subList = ARGUMENT(aEnvironment, aStackTop, 1).Get().SubList().Get();
	...
	class LispConcatenateStrings extends YacasEvalCaller {
		void ConcatenateStrings(final StringBuffer aStringBuffer, final LispEnvironment aEnvironment, final int aStackTop) throws Exception {
			...
			while (iter.GetObject() != null) {
				...
				final String thisString = iter.GetObject().String();
				final String toAppend = thisString.substring(1, thisString.length() - 1);
	...
	class LispCharString extends YacasEvalCaller {
		...
		public void Eval(final LispEnvironment aEnvironment, final int aStackTop) throws Exception {
			...
			LispError.CHK_ARG_CORE(aEnvironment, aStackTop, str != null, 2);
			LispError.CHK_ARG_CORE(aEnvironment, aStackTop, LispStandard.IsNumber(str, false), 2);
			final char asciiCode = (char) Integer.parseInt(str, 10);
	...
	class LispWhile extends YacasEvalCaller {
		@Override
		public void Eval(final LispEnvironment aEnvironment, final int aStackTop) throws Exception {
			final LispPtr arg1 = ARGUMENT(aEnvironment, aStackTop, 1);
			final LispPtr arg2 = ARGUMENT(aEnvironment, aStackTop, 2);
	...
	class LispIf extends YacasEvalCaller {
		@Override
		public void Eval(final LispEnvironment aEnvironment, final int aStackTop) throws Exception {
			final int nrArguments = LispStandard.InternalListLength(ARGUMENT(aEnvironment, aStackTop, 0));
	...
	class LispCheck extends YacasEvalCaller {
		@Override
		public void Eval(final LispEnvironment aEnvironment, final int aStackTop) throws Exception {
			final LispPtr pred = new LispPtr();
	...
	class LispHoldArg extends YacasEvalCaller {
		...
		public void Eval(final LispEnvironment aEnvironment, final int aStackTop) throws Exception {
			...
			// The arguments
			final String tohold = ARGUMENT(aEnvironment, aStackTop, 2).Get().String();
	...
	class LispUnFence extends YacasEvalCaller {
		...
		public void Eval(final LispEnvironment aEnvironment, final int aStackTop) throws Exception {
			...
			final int arity = Integer.parseInt(ARGUMENT(aEnvironment, aStackTop, 2).Get().String(), 10);
	...
	class LispRetract extends YacasEvalCaller {
		...
		public void Eval(final LispEnvironment aEnvironment, final int aStackTop) throws Exception {
			...
			final String orig = evaluated.Get().String();
			LispError.CHK_ARG_CORE(aEnvironment, aStackTop, orig != null, 1);
			final String oper = LispStandard.SymbolName(aEnvironment, orig);

			final LispPtr arity = new LispPtr();
			arity.Set(ARGUMENT(aEnvironment, aStackTop, 2).Get());
			LispError.CHK_ARG_CORE(aEnvironment, aStackTop, arity.Get().String() != null, 2);
			final int ar = Integer.parseInt(arity.Get().String(), 10);
	...
	class LispLazyAnd extends YacasEvalCaller {
		@Override
		public void Eval(final LispEnvironment aEnvironment, final int aStackTop) throws Exception {
			final LispPtr nogos = new LispPtr();
			int nrnogos = 0;
			final LispPtr evaluated = new LispPtr();
	...
	class LispEquals extends YacasEvalCaller {
		@Override
		public void Eval(final LispEnvironment aEnvironment, final int aStackTop) throws Exception {
			final LispPtr evaluated1 = new LispPtr();
			evaluated1.Set(ARGUMENT(aEnvironment, aStackTop, 1).Get());
			final LispPtr evaluated2 = new LispPtr();
			evaluated2.Set(ARGUMENT(aEnvironment, aStackTop, 2).Get());

			LispStandard.InternalBoolean(aEnvironment, RESULT(aEnvironment, aStackTop), LispStandard.InternalEquals(aEnvironment, evaluated1, evaluated2));
		}
	}
	...
	abstract class LispLexCompare2 {
		...
		void Compare(final LispEnvironment aEnvironment, final int aStackTop) throws Exception {
			final LispPtr result1 = new LispPtr();
			final LispPtr result2 = new LispPtr();
			...
			boolean cmp;
			final BigNumber n1 = result1.Get().Number(aEnvironment.Precision());
			final BigNumber n2 = result2.Get().Number(aEnvironment.Precision());
			if (n1 != null && n2 != null) {
				cmp = numfunc(n1, n2);
			} else {
				String str1;
				...
				cmp = lexfunc(str1, str2, aEnvironment.HashTable(), aEnvironment.Precision());
			}
	...
	class LexLessThan extends LispLexCompare2 {
		@Override
		boolean lexfunc(final String f1, final String f2, final LispHashTable aHashTable, final int aPrecision) {
			return f1.compareTo(f2) < 0;
		}

		@Override
		boolean numfunc(final BigNumber n1, final BigNumber n2) {
	...
	class LispIsFunction extends YacasEvalCaller {
		...
		public void Eval(final LispEnvironment aEnvironment, final int aStackTop) throws Exception {
			...
			LispStandard.InternalBoolean(aEnvironment, RESULT(aEnvironment, aStackTop), result.Get().SubList() != null);
		}
	}
	...
	class LispIsAtom extends YacasEvalCaller {
		...
		public void Eval(final LispEnvironment aEnvironment, final int aStackTop) throws Exception {
			final LispPtr result = new LispPtr();
			result.Set(ARGUMENT(aEnvironment, aStackTop, 1).Get());
			final String s = result.Get().String();
	...
	class LispIsInteger extends YacasEvalCaller {
		...
		public void Eval(final LispEnvironment aEnvironment, final int aStackTop) throws Exception {
			...
			final BigNumber num = result.Get().Number(aEnvironment.Precision());
			if (num == null) {
				LispStandard.InternalFalse(aEnvironment, RESULT(aEnvironment, aStackTop));
			} else {
	...
	class LispIsString extends YacasEvalCaller {
		...
		public void Eval(final LispEnvironment aEnvironment, final int aStackTop) throws Exception {
			final LispPtr result = new LispPtr();
			result.Set(ARGUMENT(aEnvironment, aStackTop, 1).Get());
			LispStandard.InternalBoolean(aEnvironment, RESULT(aEnvironment, aStackTop), LispStandard.InternalIsString(result.Get().String()));
		}
	}
	...
	class LispMultiply extends YacasEvalCaller {
		@Override
		public void Eval(final LispEnvironment aEnvironment, final int aStackTop) throws Exception {
			final BigNumber x = GetNumber(aEnvironment, aStackTop, 1);
			final BigNumber y = GetNumber(aEnvironment, aStackTop, 2);
			final BigNumber z = new BigNumber(aEnvironment.Precision());
	...
	class LispAdd extends YacasEvalCaller {
		@Override
		public void Eval(final LispEnvironment aEnvironment, final int aStackTop) throws Exception {
			final int length = LispStandard.InternalListLength(ARGUMENT(aEnvironment, aStackTop, 0));
			if (length == 2) {
				BigNumber x;
				...
				final BigNumber x = MathCommands.GetNumber(aEnvironment, aStackTop, 1);
				final BigNumber y = MathCommands.GetNumber(aEnvironment, aStackTop, 2);
				final int bin = aEnvironment.Precision();
				final BigNumber z = new BigNumber(bin);
	...
	class LispSubtract extends YacasEvalCaller {
		...
		public void Eval(final LispEnvironment aEnvironment, final int aStackTop) throws Exception {
			...
			if (length == 2) {
				final BigNumber x = GetNumber(aEnvironment, aStackTop, 1);
				final BigNumber z = new BigNumber(x);
				z.Negate(x);
				RESULT(aEnvironment, aStackTop).Set(new LispNumber(z));
				return;
			} else {
				final BigNumber x = GetNumber(aEnvironment, aStackTop, 1);
				final BigNumber y = GetNumber(aEnvironment, aStackTop, 2);
				final BigNumber yneg = new BigNumber(y);
				yneg.Negate(y);
				final BigNumber z = new BigNumber(aEnvironment.Precision());
	...
	class LispDivide extends YacasEvalCaller {
		...
		public void Eval(final LispEnvironment aEnvironment, final int aStackTop) throws Exception {
			...
			if (x.IsInt() && y.IsInt()) {
				...
				final BigNumber tempx = new BigNumber(aEnvironment.Precision());
				tempx.SetTo(x);
				tempx.BecomeFloat(aEnvironment.Precision()); // coerce x to float
				final BigNumber tempy = new BigNumber(aEnvironment.Precision());
				tempy.SetTo(y);
	...
	class YacasBuiltinPrecisionSet extends YacasEvalCaller {
		...
		public void Eval(final LispEnvironment aEnvironment, final int aStackTop) throws Exception {
			...
			final int ind = Integer.parseInt(index.Get().String(), 10);
	...
	class LispGetExactBits extends YacasEvalCaller {
		...
		public void Eval(final LispEnvironment aEnvironment, final int aStackTop) throws Exception {
			final BigNumber x = GetNumber(aEnvironment, aStackTop, 1);
			final BigNumber z = new BigNumber(aEnvironment.Precision());
			z.SetTo((x.IsInt()) ? x.BitCount() // for integers, return the bit count
	...
	class LispDiv extends YacasEvalCaller {
		...
		public void Eval(final LispEnvironment aEnvironment, final int aStackTop) throws Exception {
			final BigNumber x = GetNumber(aEnvironment, aStackTop, 1);
			final BigNumber y = GetNumber(aEnvironment, aStackTop, 2);
			if (x.IsInt() && y.IsInt()) { // both integer, perform integer division
				final BigNumber z = new BigNumber(aEnvironment.Precision());
				z.Divide(x, y, aEnvironment.Precision());
				RESULT(aEnvironment, aStackTop).Set(new LispNumber(z));
				return;
	...
	class LispSystemCall extends YacasEvalCaller {
		...
		public void Eval(final LispEnvironment aEnvironment, final int aStackTop) throws Exception {
			...
			final StreamGobbler og = new StreamGobbler(ls_proc.getInputStream());
			final StreamGobbler eg = new StreamGobbler(ls_proc.getErrorStream());
			...
			final Thread waitForProcess = new Thread() {
				@Override
				public void run() {
					int returncode = -1;
					try {
						...
						if (returncode != 0) {
							System.out.println("Subprocess terminated with return code " + returncode);
						}
			...
			og.join(250);
			final ArrayList<String> output = og.shutdown();
			...
			eg.join(250);
			final ArrayList<String> errors = eg.shutdown();
	...
	class LispFastArcSin extends YacasEvalCaller {
		...
		public void Eval(final LispEnvironment aEnvironment, final int aStackTop) throws Exception {
			...
			final double result = Math.asin(x.Double());
			final BigNumber z = new BigNumber(aEnvironment.Precision());
			z.SetTo(result);
			RESULT(aEnvironment, aStackTop).Set(new LispNumber(z));
		}
	...
	class LispFastLog extends YacasEvalCaller {
		...
		public void Eval(final LispEnvironment aEnvironment, final int aStackTop) throws Exception {
			BigNumber x;
			x = GetNumber(aEnvironment, aStackTop, 1);
			final double result = Math.log(x.Double());
			final BigNumber z = new BigNumber(aEnvironment.Precision());
			z.SetTo(result);
			RESULT(aEnvironment, aStackTop).Set(new LispNumber(z));
		}
	...
	class LispFastPower extends YacasEvalCaller {
		...
		public void Eval(final LispEnvironment aEnvironment, final int aStackTop) throws Exception {
			...
			final double result = Math.pow(x.Double(), y.Double());
			final BigNumber z = new BigNumber(aEnvironment.Precision());
			z.SetTo(result);
			RESULT(aEnvironment, aStackTop).Set(new LispNumber(z));
		}
	...
	class LispShiftLeft extends YacasEvalCaller {
		...
		public void Eval(final LispEnvironment aEnvironment, final int aStackTop) throws Exception {
			final BigNumber x = GetNumber(aEnvironment, aStackTop, 1);
			final BigNumber n = GetNumber(aEnvironment, aStackTop, 2);
			final long nrToShift = n.Long();
			final BigNumber z = new BigNumber(aEnvironment.Precision());
	...
	class LispFromBase extends YacasEvalCaller {
		...
		public void Eval(final LispEnvironment aEnvironment, final int aStackTop) throws Exception {
			...
			final int base = (int) (num.Double());

			// Get the number to convert
			final LispPtr fromNum = new LispPtr();
			...
			final BigNumber z = new BigNumber(str2, aEnvironment.Precision(), base);
			RESULT(aEnvironment, aStackTop).Set(new LispNumber(z));
		}
	}
	...
	class LispToBase extends YacasEvalCaller {
		...
		public void Eval(final LispEnvironment aEnvironment, final int aStackTop) throws Exception {
			...
			// Get a short platform integer from the first argument
			final int base = (int) (num.Long());

			// Get the number to convert
			final BigNumber x = GetNumber(aEnvironment, aStackTop, 2);
	...
	class LispIsBodied extends YacasEvalCaller {
		@Override
		public void Eval(final LispEnvironment aEnvironment, final int aStackTop) throws Exception {
			final LispInFixOperator op = MathCommands.OperatorInfo(aEnvironment, aStackTop, aEnvironment.iBodiedOperators);
	...
	class LispIsInFix extends YacasEvalCaller {
		@Override
		public void Eval(final LispEnvironment aEnvironment, final int aStackTop) throws Exception {
			final LispInFixOperator op = MathCommands.OperatorInfo(aEnvironment, aStackTop, aEnvironment.iInfixOperators);
			LispStandard.InternalBoolean(aEnvironment, RESULT(aEnvironment, aStackTop), op != null);
		}
	}
	...
	class LispIsPreFix extends YacasEvalCaller {
		@Override
		public void Eval(final LispEnvironment aEnvironment, final int aStackTop) throws Exception {
			final LispInFixOperator op = MathCommands.OperatorInfo(aEnvironment, aStackTop, aEnvironment.iPrefixOperators);
			LispStandard.InternalBoolean(aEnvironment, RESULT(aEnvironment, aStackTop), op != null);
		}
	}
	...
	class LispIsPostFix extends YacasEvalCaller {
		@Override
		public void Eval(final LispEnvironment aEnvironment, final int aStackTop) throws Exception {
			final LispInFixOperator op = MathCommands.OperatorInfo(aEnvironment, aStackTop, aEnvironment.iPostfixOperators);
			LispStandard.InternalBoolean(aEnvironment, RESULT(aEnvironment, aStackTop), op != null);
		}
	}
	...
	class LispSecure extends YacasEvalCaller {
		@Override
		public void Eval(final LispEnvironment aEnvironment, final int aStackTop) throws Exception {
			final boolean prevSecure = aEnvironment.iSecure;
	...
	class LispFindFile extends YacasEvalCaller {
		...
		public void Eval(final LispEnvironment aEnvironment, final int aStackTop) throws Exception {
			...
			final String filename = LispStandard.InternalFindFile(oper, aEnvironment.iInputDirectories);
	...
	class LispFindFunction extends YacasEvalCaller {
		...
		public void Eval(final LispEnvironment aEnvironment, final int aStackTop) throws Exception {
			...
			final LispMultiUserFunction multiUserFunc = aEnvironment.MultiUserFunction(aEnvironment.HashTable().LookUp(oper));
			if (multiUserFunc != null) {
				final LispDefFile def = multiUserFunc.iFileToOpen;
				if (def != null) {
	...
	class GenArrayCreate extends YacasEvalCaller {
		@Override
		public void Eval(final LispEnvironment aEnvironment, final int aStackTop) throws Exception {
			final LispPtr sizearg = new LispPtr();
			...
			final int size = Integer.parseInt(sizearg.Get().String(), 10);

			final LispPtr initarg = new LispPtr();
			initarg.Set(ARGUMENT(aEnvironment, aStackTop, 2).Get());

			final ArrayClass array = new ArrayClass(size, initarg.Get());
	...
	class GenArraySize extends YacasEvalCaller {
		...
		public void Eval(final LispEnvironment aEnvironment, final int aStackTop) throws Exception {
			...
			final GenericClass gen = evaluated.Get().Generic();
	...
	class GenArrayGet extends YacasEvalCaller {
		...
		public void Eval(final LispEnvironment aEnvironment, final int aStackTop) throws Exception {
			...
			final LispObject object = ((ArrayClass) gen).GetElement(size);
	...
	class LispReadLisp extends YacasEvalCaller {
		@Override
		public void Eval(final LispEnvironment aEnvironment, final int aStackTop) throws Exception {
			final LispParser parser = new LispParser(aEnvironment.iCurrentTokenizer, aEnvironment.iCurrentInput, aEnvironment);
			// Read expression
			parser.Parse(RESULT(aEnvironment, aStackTop));
		}
	}
	...
	class LispType extends YacasEvalCaller {
		...
		public void Eval(final LispEnvironment aEnvironment, final int aStackTop) throws Exception {
			final LispPtr evaluated = new LispPtr();
			evaluated.Set(ARGUMENT(aEnvironment, aStackTop, 1).Get());
			final LispPtr subList = evaluated.Get().SubList();
	...
	class YacasStringMidGet extends YacasEvalCaller {
		...
		public void Eval(final LispEnvironment aEnvironment, final int aStackTop) throws Exception {
			...
			LispError.CHK_ARG_CORE(aEnvironment, aStackTop, index.Get() != null, 1);
			LispError.CHK_ARG_CORE(aEnvironment, aStackTop, index.Get().String() != null, 1);
			final int from = Integer.parseInt(index.Get().String(), 10);
			LispError.CHK_ARG_CORE(aEnvironment, aStackTop, from > 0, 1);

			index.Set(ARGUMENT(aEnvironment, aStackTop, 2).Get());
			LispError.CHK_ARG_CORE(aEnvironment, aStackTop, index.Get() != null, 2);
			LispError.CHK_ARG_CORE(aEnvironment, aStackTop, index.Get().String() != null, 2);
			final int count = Integer.parseInt(index.Get().String(), 10);

			final String str = "\"" + orig.substring(from, from + count) + "\"";
	...
	class GenPatternCreate extends YacasEvalCaller {
		@Override
		public void Eval(final LispEnvironment aEnvironment, final int aStackTop) throws Exception {
			final LispPtr pattern = new LispPtr();
			pattern.Set(ARGUMENT(aEnvironment, aStackTop, 1).Get());
			final LispPtr postpredicate = new LispPtr();
			postpredicate.Set(ARGUMENT(aEnvironment, aStackTop, 2).Get());

			final LispIterator iter = new LispIterator(pattern);
			...
			final LispPtr ptr = iter.Ptr();

			final YacasPatternPredicateBase matcher = new YacasPatternPredicateBase(aEnvironment, ptr, postpredicate);
			final PatternClass p = new PatternClass(matcher);
	...
	class GenPatternMatches extends YacasEvalCaller {
		...
		public void Eval(final LispEnvironment aEnvironment, final int aStackTop) throws Exception {
			final LispPtr pattern = new LispPtr();
			pattern.Set(ARGUMENT(aEnvironment, aStackTop, 1).Get());
			final GenericClass gen = pattern.Get().Generic();
			LispError.CHK_ARG_CORE(aEnvironment, aStackTop, gen != null, 1);
			LispError.CHK_ARG_CORE(aEnvironment, aStackTop, gen.TypeName().equals("\"Pattern\""), 1);

			final LispPtr list = new LispPtr();
			list.Set(ARGUMENT(aEnvironment, aStackTop, 2).Get());

			final PatternClass patclass = (PatternClass) gen;

			final LispIterator iter = new LispIterator(list);
			...
			final boolean matches = patclass.Matches(aEnvironment, ptr);
	...
	class LispRuleBaseDefined extends YacasEvalCaller {
		@Override
		public void Eval(final LispEnvironment aEnvironment, final int aStackTop) throws Exception {
			final LispPtr name = new LispPtr();
			name.Set(ARGUMENT(aEnvironment, aStackTop, 1).Get());
			final String orig = name.Get().String();
			LispError.CHK_ARG_CORE(aEnvironment, aStackTop, orig != null, 1);
			final String oper = LispStandard.InternalUnstringify(orig);
			...
			final int arity = Integer.parseInt(sizearg.Get().String(), 10);

			final LispUserFunction userFunc = aEnvironment.UserFunction(aEnvironment.HashTable().LookUp(oper), arity);
	...
	class LispRuleBaseArgList extends YacasEvalCaller {
		...
		public void Eval(final LispEnvironment aEnvironment, final int aStackTop) throws Exception {
			...
			final LispPtr list = userFunc.ArgList();
			final LispPtr head = new LispPtr();
			head.Set(aEnvironment.iList.Copy(false));
	...
	class LispSubst extends YacasEvalCaller {
		@Override
		public void Eval(final LispEnvironment aEnvironment, final int aStackTop) throws Exception {
			final LispPtr from = new LispPtr(), to = new LispPtr(), body = new LispPtr();
			...
			final SubstBehaviour behaviour = new SubstBehaviour(aEnvironment, from, to);
	...
	class LispLocalSymbols extends YacasEvalCaller {
		...
		public void Eval(final LispEnvironment aEnvironment, final int aStackTop) throws Exception {
			final int nrArguments = LispStandard.InternalListLength(ARGUMENT(aEnvironment, aStackTop, 0));
			final int nrSymbols = nrArguments - 2;

			final String names[] = new String[nrSymbols];
			final String localnames[] = new String[nrSymbols];

			final int uniquenumber = aEnvironment.GetUniqueId();
			int i;
			for (i = 0; i < nrSymbols; i++) {
				final String atomname = Argument(ARGUMENT(aEnvironment, aStackTop, 0), i + 1).Get().String();
				LispError.CHK_ARG_CORE(aEnvironment, aStackTop, atomname != null, i + 1);
				names[i] = atomname;

				final String newname = "$" + atomname + uniquenumber;
				final String variable = aEnvironment.HashTable().LookUp(newname);
				localnames[i] = variable;
			}
			final LocalSymbolBehaviour behaviour = new LocalSymbolBehaviour(aEnvironment, names, localnames, nrSymbols);
			final LispPtr result = new LispPtr();
	...
	class LispFastIsPrime extends YacasEvalCaller {
		...
		public void Eval(final LispEnvironment aEnvironment, final int aStackTop) throws Exception {
			...
			int i = 2;
			final int max = (int) (1 + Math.sqrt(n));
	...
	class LispApplyPure extends YacasEvalCaller {
		...
		public void Eval(final LispEnvironment aEnvironment, final int aStackTop) throws Exception {
			...
			if (oper.Get().String() != null) {
				LispStandard.InternalApplyString(aEnvironment, RESULT(aEnvironment, aStackTop), oper.Get().String(), args.Get().SubList().Get().Next());
			} else { // Apply a pure function {args,body}.
				final LispPtr args2 = new LispPtr();
	...
	class LispPatchString extends YacasEvalCaller {
		@Override
		public void Eval(final LispEnvironment aEnvironment, final int aStackTop) throws Exception {
			final String unpatchedString = YacasEvalCaller.ARGUMENT(aEnvironment, aStackTop, 1).Get().String();
			...
			final StringOutput resultStream = new StringOutput(resultBuffer);
	...
	class YacasExtraInfoSet extends YacasEvalCaller {
		@Override
		public void Eval(final LispEnvironment aEnvironment, final int aStackTop) throws Exception {
			final LispPtr object = new LispPtr();
			object.Set(ARGUMENT(aEnvironment, aStackTop, 1).Get());

			final LispPtr info = new LispPtr();
	...
	class YacasExtraInfoGet extends YacasEvalCaller {
		...
		public void Eval(final LispEnvironment aEnvironment, final int aStackTop) throws Exception {
			...
			final LispPtr result = object.Get().ExtraInfo();
			if (result == null) {
				LispStandard.InternalFalse(aEnvironment, RESULT(aEnvironment, aStackTop));
	...
	class LispExplodeTag extends YacasEvalCaller {
		...
		public void Eval(final LispEnvironment aEnvironment, final int aStackTop) throws Exception {
			...
			while (str.charAt(strInd) != '>' && str.charAt(strInd) != '/') {
				...
				{
					final LispObject ls = LispAtom.New(aEnvironment, "List");
					final LispObject nm = LispAtom.New(aEnvironment, name);
					final LispObject vl = LispAtom.New(aEnvironment, value);
					nm.Next().Set(vl);
					ls.Next().Set(nm);
					final LispObject newinfo = LispSubList.New(ls);
			...
			final LispObject xm = LispAtom.New(aEnvironment, "XmlTag");
			final LispObject tg = LispAtom.New(aEnvironment, tag);
			final LispObject tp = LispAtom.New(aEnvironment, type);
			info.Next().Set(tp);
			tg.Next().Set(info);
			xm.Next().Set(tg);
		...
		public void Eval(final LispEnvironment aEnvironment, final int aStackTop) throws Exception {
			...
			while (t != null) {
				if (t.SubList() != null) {
					...
					if (sub != null) {
						sub = sub.Next().Get();
						final LispPtr temp = new LispPtr();
						temp.Set(sub);
	...
	class LispBackQuote extends YacasEvalCaller {
		@Override
		public void Eval(final LispEnvironment aEnvironment, final int aStackTop) throws Exception {
			final BackQuoteBehaviour behaviour = new BackQuoteBehaviour(aEnvironment);
			final LispPtr result = new LispPtr();
	...
	class LispFileSize extends YacasEvalCaller {
		@Override
		public void Eval(final LispEnvironment aEnvironment, final int aStackTop) throws Exception {
			final LispPtr fnameObject = new LispPtr();
			fnameObject.Set(ARGUMENT(aEnvironment, aStackTop, 1).Get());
			LispError.CHK_ISSTRING_CORE(aEnvironment, aStackTop, fnameObject, 1);
			final String fname = LispStandard.InternalUnstringify(fnameObject.Get().String());
			final String hashedname = aEnvironment.HashTable().LookUp(fname);
