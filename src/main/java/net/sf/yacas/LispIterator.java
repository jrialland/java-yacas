...
/**
 * class LispIterator works almost like LispPtr, but doesn't enforce reference counting, so it should be slightly faster. This one should be used in stead of LispPtr if you are going to traverse a lisp expression in a non-destructive way.
 */
class LispIterator {
