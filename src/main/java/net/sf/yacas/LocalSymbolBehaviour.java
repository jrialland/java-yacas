...
/**
 * subst behaviour for changing the local variables to have unique names.
 */
class LocalSymbolBehaviour implements SubstBehaviourBase {
	public LocalSymbolBehaviour(LispEnvironment aEnvironment, String[] aOriginalNames, String[] aNewNames, int aNrNames) {
