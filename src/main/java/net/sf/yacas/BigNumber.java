...
class BigNumber {
	...
	// constructors
	public BigNumber(final String aString, final int aBasePrecision, final int aBase/*=10*/) {
		SetTo(aString, aBasePrecision, aBase);
	}

	// / copy constructor
	public BigNumber(final BigNumber aOther) {
		SetTo(aOther);
	}

	// no constructors from int or double to avoid automatic conversions
	public BigNumber(final int aPrecision/* = 20*/) {
	...
	public void SetTo(final BigNumber aOther) {
	...
	boolean IsFloat(final String aString, final int aBase) {
	...
	public void SetTo(String aString, final int aPrecision, final int aBase/*=10*/) {
		integer = null;
		decimal = null;
		final boolean isFloat = IsFloat(aString, aBase);
	...
	public void SetTo(final long value) {
	...
	public String ToString(final int aPrecision, final int aBase/*=10*/) {
		if (integer != null) {
			...
			final int dotPos = result.indexOf('.');
			if (dotPos >= 0) {
	...
	public boolean Equals(final BigNumber aOther) {
		if (integer != null) {
			if (aOther.integer == null) {
				// hier
				final BigDecimal x = GetDecimal(this);
	...
	public boolean IsSmall() {
		if (IsInt()) {
			final BigInteger i = integer.abs();
	...
	public void BecomeFloat(final int aPrecision/*=0*/) {
		if (integer != null) {
	...
	public boolean LessThan(final BigNumber aOther) {
		final boolean floatResult = (decimal != null || aOther.decimal != null);
		if (floatResult) {
			final BigDecimal dX = GetDecimal(this);
			final BigDecimal dY = GetDecimal(aOther);
	...
	public void Multiply(final BigNumber aX, final BigNumber aY, final int aPrecision) {
		final boolean floatResult = (aX.decimal != null || aY.decimal != null);
		if (floatResult) {
			final BigDecimal dX = GetDecimal(aX);
			final BigDecimal dY = GetDecimal(aY);
			integer = null;
			decimal = dX.multiply(dY);
			final int newScale = iPrecision;
	...
	public void Add(final BigNumber aX, final BigNumber aY, final int aPrecision) {
		final boolean floatResult = (aX.decimal != null || aY.decimal != null);
		if (floatResult) {
	...
	public void Negate(final BigNumber aX) {
		if (aX.integer != null) {
			decimal = null;
	...
	public void Divide(final BigNumber aX, final BigNumber aY, final int aPrecision) {
		final boolean floatResult = (aX.decimal != null || aY.decimal != null);
		if (floatResult) {
			BigDecimal dX = GetDecimal(aX);
			final BigDecimal dY = GetDecimal(aY);
			integer = null;
			final int newScale = aPrecision + aY.GetPrecision();
	...
	public void Mod(final BigNumber aY, final BigNumber aZ) throws Exception {
	...
	public void DumpDebugInfo(final LispOutput aOutput) throws Exception {
		if (integer != null) {
	...
	public void Floor(final BigNumber aX) {
		if (aX.decimal != null) {
			...
			if (aX.decimal.signum() < 0) {
				final BigDecimal back = new BigDecimal(rounded);
				final BigDecimal difference = aX.decimal.subtract(back);
	...
	public void Precision(final int aPrecision) {
		iPrecision = aPrecision;
		if (decimal != null) {
	...
	void ShiftLeft(final BigNumber aX, final int aNrToShift) throws Exception {
		LispError.LISPASSERT(aX.integer != null);
		decimal = null;
		integer = aX.integer.shiftLeft(aNrToShift);
	}

	void ShiftRight(final BigNumber aX, final int aNrToShift) throws Exception {
		LispError.LISPASSERT(aX.integer != null);
		decimal = null;
		integer = aX.integer.shiftRight(aNrToShift);
	}

	void Gcd(final BigNumber aX, final BigNumber aY) throws Exception {
		LispError.LISPASSERT(aX.integer != null);
	...
	void BitAnd(final BigNumber aX, final BigNumber aY) throws Exception {
		LispError.LISPASSERT(aX.integer != null);
		LispError.LISPASSERT(aY.integer != null);
	...
	void BitOr(final BigNumber aX, final BigNumber aY) throws Exception {
		LispError.LISPASSERT(aX.integer != null);
		LispError.LISPASSERT(aY.integer != null);
	...
	void BitXor(final BigNumber aX, final BigNumber aY) throws Exception {
		LispError.LISPASSERT(aX.integer != null);
		LispError.LISPASSERT(aY.integer != null);
	...
	void BitNot(final BigNumber aX) throws Exception {
		LispError.LISPASSERT(aX.integer != null);
	...
	BigDecimal GetDecimal(final BigNumber aNumber) {
