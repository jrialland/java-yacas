...
class SelectSymbol {
	...
	public SelectSymbol(final int width, final int spacing) {
		ix = iy = 0;
		nr_symbols = 0;
		iwidth = width;
		ispacing = spacing;
	...
	public void draw(final int xpos, final int ypos, final YacasGraphicsContext aGraphicsContext) {
	...
	public int height(final YacasGraphicsContext aGraphicsContext) {
