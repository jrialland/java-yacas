...
/**
 * class LispObject is the base object class that can be put in linked lists. It either has a pointer to a string, obtained through String(), or it is a holder for a sublist, obtainable through SubList(), or it is a generic object, in which case
 * Generic() returns non-NULL. Only one of these three functions should return a non-NULL value. It is a reference-counted object. LispPtr handles the reference counting.
 */
abstract class LispObject extends LispPtr {
	...
	/**
	 * Return string representation, or NULL if the object doesn't have one. the string representation is only relevant if the object is a simple atom. This method returns NULL by default.
	 */
	public abstract String String() throws Exception;

	/**
	 * If this object is a list, return a pointer to it. Default behaviour is to return NULL.
	 */
	...
	/**
	 * Return a pointer to extra info. This allows for annotating an object. Returns NULL by default.
	 */
